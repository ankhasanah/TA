<?php
	...
	{
		$querylogin = mysql_query("SELECT * FROM login WHERE username = '$_POST[username]' AND password = '$_POST[lama]'");
		if ($datalogin = mysql_fetch_array($querylogin))
		{
			if ($_POST['baru'] == $_POST['konfirmasi'])
			{
				mysql_query("UPDATE login SET password = '$_POST[baru]' WHERE username = '$_POST[username]'");
                  ...
                  <li class="menu">
                      <a href="follow.php">
                          ...
                          <span>Follow</span>
									...
									<li class="menu">
                      <a class="active" href="ganti-password.php">
                          <i class="fa fa-key"></i>
						      ...
						      <form id="form1" name="form1" method="post" action="">
						        <table width="350" border="0" cellpadding="5" cellspacing="1" bgcolor="#000099">
						          <tr>
						            ...
						            <td width="180" bgcolor="#FFFFFF"><input type="text" name="username" class="form-control" id="username" value="<?php echo $_SESSION['userlogin']; ?>" readonly /></td>
						          </tr>
						          <tr>
						            <td bgcolor="#FFFFFF">Password Lama</td>
						            <td bgcolor="#FFFFFF"><input type="password" name="lama" class="form-control" id="lama" /></td>
						          </tr>
						          <tr>
						            <td bgcolor="#FFFFFF">Password Baru</td>
						            <td bgcolor="#FFFFFF"><input type="password" name="baru" class="form-control" id="baru" /></td>
						          </tr>
						          <tr>
						            <td bgcolor="#FFFFFF">Konfirmasi Password</td>
						            <td bgcolor="#FFFFFF"><input type="password" name="konfirmasi" class="form-control" id="konfirmasi" /></td>
						          </tr>
						          <tr>
