						  ...
						  <tr>
						    ...
						    <strong>Data Gejala</strong><br />
						      ...
						      <table width="468" class="table table-bordered">
						        <tr>
						          <td width="73" align="center" bgcolor="#FFFFFF"><span class="style1">ID Gejala</span></td>
						          <td width="80%" align="center" bgcolor="#FFFFFF"><span class="style1">Nama Gejala</span></td>
						          <td colspan="2" align="center" bgcolor="#FFFFFF"><a href="add-gejala.php" class="style1">Add</a></td>
						        </tr>
						        <?php
						        ...
						        echo "<tr>";
						          echo "<td bgcolor=#FFFFFF align=center>  $row[id_mchatrf]</td>";
						          echo"<td bgcolor=#FFFFFF> $row[pertanyaan]</td>";
						          echo "<td width=59 align=center bgcolor=#FFFFFF><a href='edit-gejala.php?id_mchatrf=".$row['id_mchatrf']." '><span class='fa fa-pencil'></span></a></td>";
						          echo" <td width=72 align=center bgcolor=#FFFFFF><a href='edit-gejala.php?id_mchatrf=".$row['id_mchatrf']."'></a> <a href='del-gejala.php?id_mchatrf=".$row['id_mchatrf']."'><span class='glyphicon glyphicon-trash'></span></a></td>";
						       echo "</tr>";
