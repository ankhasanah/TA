          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                    ...
                    <li class="menu">
                      <a class="active" href="follow.php">
                          <i class="fa fa-th"></i>
						...
						<table width="100%" class="table">
						  ...
						  <tr>
						    <td align="center" valign="top" bgcolor="#FFFFFF"><br />
						      <strong>Edit Data Gejala observasi</strong><br />
						      <br />
						      <?php
						      	
						      		$id = $_GET['id'];
									$query 		= "SELECT * FROM `penyaring` where id='$id'";
						      ...
						      <form id="form1" name="form1" method="post" action=update2.php  >
						        <table class="table table-striped">
						          <tr>
						            ...
						            <td bgcolor="#FFFFFF"><input type="text" name="id" id="id" class="form-control" readonly value="<?php echo $buff['id']; ?>" /></td>
						          </tr>
						          <tr>
						            <td width="128" bgcolor="#FFFFFF">Nama Gejala</td>
						            <td width="249" bgcolor="#FFFFFF"><input type="text" name="penyaring" class="form-control" required id="penyaring" value="<?php echo $buff['penyaring']; ?>" /></td>
						          </tr>
						          <tr>
