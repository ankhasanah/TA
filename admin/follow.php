						    ...
						    <strong>Data Gejala</strong><br />
						      ...
						      <table width="468" class="table table-bordered">
						        ...
						        echo "<tr>";
						          ...
						          echo"<td bgcolor=#FFFFFF> $row[penyaring]</td>";
						          echo "<td width=59 align=center bgcolor=#FFFFFF><a href='edit-gejala2.php?id=".$row['id']." '><span class='fa fa-pencil'></span></a></td>";
						          echo" <td width=72 align=center bgcolor=#FFFFFF><a href='edit-gejala2.php?id=".$row['id']."'></a> <a href='del-gejala2.php?id=".$row['id']."'><span class='glyphicon glyphicon-trash'></span></a></td>";
						       echo "</tr>";
