<?php
	...
	{
		mysql_query("INSERT INTO 'mchatr/f' (id_mchatrf, pertanyaan, jawaban) VALUES ('$_POST[id_mchatrf]', '$_POST[pertanyaan]', '$_POST[jawaban]')");
			...
			<section id="main-content">
					...
					<form method="POST" action="../aksi/input_loksai.php" enctype="multipart/form-data"> 
		               ...
		               <table class="table table-striped">
		                 ...
		                 <tr>
		                  <td>Latitude</td>
		                  <td><input class="form-control" type="text" name='lat' id='lat'></td>
		                 </tr>
		                 <tr>
		                  <td>Longitude</td>
		                  <td><input class="form-control" type="text" name='lng' id='lng'></td>
		                 </tr>
		                 <tr>
						    ...
						    <td align="center" valign="top" bgcolor="#FFFFFF"><br />
						      ...
						      <form id="form1" name="form1" method="post" action="">
						        <table width="350" border="0" cellpadding="5" cellspacing="1" bgcolor="#000099">
						          ...
						          <tr>
						            <td bgcolor="#FFFFFF">Gejala</td>
						            <td bgcolor="#FFFFFF"><input type="text" name="pertanyaan" id="pertanyaan" class="form-control" required/></td>
						          </tr>
						          <tr>
						            <td bgcolor="#FFFFFF">Jawaban</td>
						            <td bgcolor="#FFFFFF"><input type="text" name="jawaban" id="jawaban" class="form-control" required/></td>
						          </tr>
						          <tr>
